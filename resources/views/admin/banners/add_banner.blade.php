        ...
        <div class="widget-box">
         ...
         @if(Session::has('flash_message_success'))
          ...
          <div class="widget-content nopadding">
            ...
            action="{{ url('/admin/add-banner') }}" name="add_product" id="add_product"
            novalidate="novalidate"> {{ csrf_field() }}
              ...
              <div class="control-group">
                <label class="control-label">Bannner Color</label>
                <div class="controls">
                  <input type="text" name="brand_color" id="brand_color">
                </div>
              </div>
